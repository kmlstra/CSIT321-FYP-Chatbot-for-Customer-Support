      ...
      if (data.success) {
        ...
        setAppointments(prev => prev.map(apt => 
          apt.appointment_id === appointmentId 
            ? { ...apt, status: newStatus as 'pending' | 'confirmed' | 'cancelled' | 'completed' }
            : apt
        ));
      } else {
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {Object.entries(
                ...
                <div key={status} className="text-center">
                  <div className={`inline-flex items-center justify-center w-12 h-12 rounded-full ${statusColors[status as keyof typeof statusColors]} mb-2`}>
